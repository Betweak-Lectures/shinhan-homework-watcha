...
const schema = {
  ...
  title: String,
  year: Number,
  poster: { hd: String, xlarge: String, large: String, medium: String, small: String },
  badges: [{ service: String, name: String, image: String }],
  on_watchaplay: Boolean,
  ratings_avg: Number,
  director_names: [String],
  stillcut: { original: String, fullhd: String, xlarge: String, large: String, medium: String, small: String },
  nations: [{ name: String }],
  genres: [String],
  description: String,
  ...
  gallery: [{ original: String, fullhd: String, xlarge: String, large: String, medium: String, small: String }],
  decks: {
    next_uri: String,
    result: [
      {
